...
/**
 * View class for a list of Mailtester.
 */
class MailtesterViewEmails extends JViewLegacy {
    ...
    public function display($tpl = null) {
        ...
        MailtesterHelper::addSubmenu('emails');
    ...
    protected function addToolbar() {
        ...
        $canDo = MailtesterHelper::getActions($state->get('filter.category_id'));

        JToolBarHelper::title(JText::_('COM_MAILTESTER_TITLE_EMAILS'), 'emails.png');
        ...
        if ($canDo->get('core.admin')) {
            JToolBarHelper::preferences('com_mailtester');
        }

        //Set sidebar action - New in 3.0
        JHtmlSidebar::setAction('index.php?option=com_mailtester&view=emails');
	...
	protected function getSortFields()
	{
		...
		'a.senddate' => JText::_('COM_MAILTESTER_EMAILS_SENDDATE'),
		'a.createddate' => JText::_('COM_MAILTESTER_EMAILS_CREATEDDATE'),
		);
	}
